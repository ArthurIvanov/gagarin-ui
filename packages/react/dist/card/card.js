...
var StyledCard = styled_components_1.default.section(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    border-radius: ", ";\n    background-color: ", ";\n    display: flex;\n    flex-direction: column;\n    box-shadow: ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n"], ["\n    border-radius: ", ";\n    background-color: ", ";\n    display: flex;\n    flex-direction: column;\n    box-shadow: ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n"])), function (props) { return props.theme.borderRadius; }, function (props) { return props.theme.colors.neutral[25]; }, function (props) { return props.theme.elevation.medium.medium; }, function (props) {
    return props.size === 'full' &&
        "\n        padding: 0; \n    ";
}, function (props) {
    return props.size === 'large' &&
        "\n        padding: ".concat(props.theme.spacing[12], "; \n    ");
}, function (props) {
    return props.size === 'standard' &&
        "\n        padding: ".concat(props.theme.spacing[24], "; \n    ");
}, function (props) {
    return props.size === 'compact' &&
        "\n        padding: ".concat(props.theme.spacing[48], "; \n    ");
}, function (props) {
    return props.size === 'landing' &&
        "\n        padding: ".concat(props.theme.spacing[64], "; \n    ");
});
