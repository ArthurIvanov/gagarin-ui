...
var TabPanel = function (_a) {
    ...
    var active = (0, react_1.useContext)(tabs_context_1.default).active;
    return (react_1.default.createElement(StyledTabPanel, { tabIndex: 0, role: "tabpanel", id: "panel-".concat(id), "aria-labelledby": "tab-".concat(id), hidden: active !== id }, children));
};
