...
var StyledLabel = styled_components_1.default.label(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    display: flex;\n    align-items: center;\n    width: 100%;\n\n    span.input-label {\n        color: ", ";\n        margin-left: ", ";\n        font-weight: ", ";\n    }\n\n    span {\n        display: block;\n        font-size: ", ";\n        line-height: ", ";\n        font-family: ", ";\n\n        margin: 0;\n    }\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n"], ["\n    display: flex;\n    align-items: center;\n    width: 100%;\n\n    span.input-label {\n        color: ", ";\n        margin-left: ", ";\n        font-weight: ", ";\n    }\n\n    span {\n        display: block;\n        font-size: ", ";\n        line-height: ", ";\n        font-family: ", ";\n\n        margin: 0;\n    }\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n\n    ", ";\n"])), function (props) { return props.theme.colors.neutral[400]; }, function (props) { return props.theme.spacing[8]; }, function (props) { return props.theme.typography.fontWeight.regular; }, function (props) { return props.theme.typography.fontSize.label; }, function (props) { return props.theme.typography.lineHeight.label; }, function (props) { return props.theme.typography.family.base; }, function (props) {
    return props.input &&
        "      \n            flex-direction: column;\n            align-items: flex-start;\n            span.input-alert {\n                color: ".concat(props.theme.colors.neutral[400], ";\n                font-size: ").concat(props.theme.typography.fontSize.subLabel, ";\n                line-height: ").concat(props.theme.typography.lineHeight.subLabel, ";\n                font-weight: ").concat(props.theme.typography.fontWeight.regular, ";\n                margin-top: ").concat(props.theme.spacing[4], ";\n                }\n            span.input-label {\n                color: ").concat(props.theme.colors.neutral[400], ";\n                margin-bottom: ").concat(props.theme.spacing[4], ";\n                font-weight: ").concat(props.theme.typography.fontWeight.medium, ";\n                margin-left: 0;\n            }\n \n            \n    ");
}, function (props) {
    return props.danger &&
        "      \n            span.input-alert {\n            color: ".concat(props.theme.colors.danger[300], ";\n            }\n               \n    ");
}, function (props) {
    return props.success &&
        "      \n            span.input-alert {\n            color: ".concat(props.theme.colors.success[300], ";\n            }\n               \n    ");
}, function (props) {
