...
var items_stack_1 = require("../items-stack");
var StyledAlert = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    position: relative;\n    display: flex;\n    max-width: 500px;\n    font-size: ", ";\n    line-height: ", ";\n    padding: ", "\n        ", ";\n    border: 1px solid;\n    border-radius: ", ";\n    color: ", ";\n\n    .status-content {\n        position: absolute;\n        left: ", ";\n        top: ", ";\n    }\n\n    .close-button {\n        position: absolute;\n        right: ", ";\n        top: ", ";\n        cursor: pointer;\n    }\n\n    ", "\n\n    ", "\n    \n    ", "\n\n    ", "\n"], ["\n    position: relative;\n    display: flex;\n    max-width: 500px;\n    font-size: ", ";\n    line-height: ", ";\n    padding: ", "\n        ", ";\n    border: 1px solid;\n    border-radius: ", ";\n    color: ", ";\n\n    .status-content {\n        position: absolute;\n        left: ", ";\n        top: ", ";\n    }\n\n    .close-button {\n        position: absolute;\n        right: ", ";\n        top: ", ";\n        cursor: pointer;\n    }\n\n    ", "\n\n    ", "\n    \n    ", "\n\n    ", "\n"])), function (props) { return props.theme.typography.fontSize.base; }, function (props) { return props.theme.typography.lineHeight.base; }, function (props) { return props.theme.spacing[16]; }, function (props) { return props.theme.spacing[48]; }, function (props) { return props.theme.borderRadius; }, function (props) { return props.theme.colors.neutral[400]; }, function (props) { return props.theme.spacing[16]; }, function (props) { return props.theme.spacing[16]; }, function (props) { return props.theme.spacing[16]; }, function (props) { return props.theme.spacing[16]; }, function (props) {
    return props.alertStatus === 'info' &&
        " \n        border-color: ".concat(props.theme.colors.info[200], ";\n        background-color: ").concat(props.theme.colors.info[100], "; \n        \n        .status-content {\n            color: ").concat(props.theme.colors.info[200], ";\n        }\n             \n    }\n    ");
}, function (props) {
    return props.alertStatus === 'success' &&
        " \n        border-color: ".concat(props.theme.colors.success[200], ";\n        background-color: ").concat(props.theme.colors.success[100], "; \n        \n        .status-content {\n            color: ").concat(props.theme.colors.success[200], ";\n        }\n             \n    }\n    ");
}, function (props) {
    return props.alertStatus === 'warning' &&
        " \n        border-color: ".concat(props.theme.colors.warning[200], ";\n        background-color: ").concat(props.theme.colors.warning[100], "; \n        \n        .status-content {\n            color: ").concat(props.theme.colors.warning[200], ";\n        }\n             \n    }\n    ");
}, function (props) {
    return props.alertStatus === 'danger' &&
        " \n        border-color: ".concat(props.theme.colors.danger[200], ";\n        background-color: ").concat(props.theme.colors.danger[100], "; \n        \n        .status-content {\n            color: ").concat(props.theme.colors.danger[200], ";\n\n        }\n             \n    }\n    ");
});
...
var AlertIcon = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        alertStatus === 'danger' && (react_1.default.createElement(icons_1.Icon, { className: "status-content", name: "alert-triangle" })),
        alertStatus === 'info' && (react_1.default.createElement(icons_1.Icon, { className: "status-content", name: "info" })),
        alertStatus === 'success' && (react_1.default.createElement(icons_1.Icon, { className: "status-content", name: "check-circle" })),
        alertStatus === 'warning' && (react_1.default.createElement(icons_1.Icon, { className: "status-content", name: "alert-circle" }))));
};
exports.AlertIcon = AlertIcon;
var CloseIcon = function (_a) {
    var isClosable = _a.isClosable;
    return (react_1.default.createElement(react_1.default.Fragment, null, isClosable && (react_1.default.createElement(icons_1.Icon, { className: "close-button", name: "close" }))));
};
exports.CloseIcon = CloseIcon;
var AlertTitle = function (_a) {
    var alertTitle = _a.alertTitle;
    return (react_1.default.createElement(typography_1.Heading, { as: "h6" }, alertTitle));
};
